 ...
 */
export function toPackagerArch(arch) {
    switch (arch) {
 ...
 */
export function toPackagerArchs(archs) {
 ...
 */
export function toPackagerPlatform(platform) {
    switch (platform) {
        case Platform.Linux:
            return "linux";
 ...
 */
export function generatePackage(platform) {
    let packConfig = {
