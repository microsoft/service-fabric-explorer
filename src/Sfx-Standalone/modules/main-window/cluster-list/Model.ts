...
// }
export class Menu{
    private static _instance:Menu = new Menu();
    ...
    public removeCluster(cluster_label: string, folder_label: string) {
        ...
        let cluster_index = folder.indexOf(this.getCluster(cluster_label));
    ...
    public renameCluster(old_name: string, new_name: string) {
        this.getCluster(old_name).label = new_name;
    }
    public moveCluster(label: string, new_folder_label: string) {
        let cluster: Cluster = this.getCluster(label);
    ...
    public clusterExists(label: string) : boolean {
        return (this.getCluster(label) != null);
    }
    ...
    private getCluster(label: string){
    ...
    private getFolder(label: string){
        for(let folder of this.folders){
