import { PublicClientApplication, LogLevel, CryptoProvider, AuthorizationCodeRequest, Configuration } from '@azure/msal-node';
...
export default class AuthProvider {
    ...
    async login() {
        ...
        await this.handleResponse(authResult);
    ...
    async getToken(tokenRequest: any) {
        let authResponse;
        const authWindow = new BrowserWindow({
            title: `TEST Azure Active Directory Authentication: `,
            width: 800,
            height: 600,
            modal: true,
            minimizable: false,
    ...
    async getTokenInteractive(authWindow: BrowserWindow, tokenRequest: any) {
        ...
        //TODO replace with properly pulling info
        protocol.registerFileProtocol("msal://redirect", (req, callback) => {
