...
@NgModule({
  declarations: [ActionDialogComponent, MessageWithConfirmation, ArmWarningComponent, DialogBodyDirective],
  imports: [
    CommonModule,
    SharedModule,
    FormsModule
  ],
  exports: [ActionDialogComponent, MessageWithConfirmation, ArmWarningComponent, DialogBodyDirective]
})
