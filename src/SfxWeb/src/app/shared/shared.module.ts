...
@NgModule({
  declarations: [NavbarComponent, ClipBoardComponent, HealthBadgeComponent, DragDirective, UpgradeProgressComponent, CandyBarCompactComponent, DetailListComponent, DetailViewPartComponent, PagerComponent],
  imports: [
    CommonModule,
    RouterModule
  ],
  exports: [NavbarComponent, ClipBoardComponent, HealthBadgeComponent, DragDirective, UpgradeProgressComponent, CandyBarCompactComponent, DetailListComponent, DetailViewPartComponent, PagerComponent]
})
