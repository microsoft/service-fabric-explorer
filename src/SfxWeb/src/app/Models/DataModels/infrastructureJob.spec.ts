import { InfrastructureJob, InProgressStatus } from './infrastructureJob';
import { IRawInfrastructureJob } from '../RawDataTypes';
import { DataService } from 'src/app/services/data.service';
import { TimeUtils } from 'src/app/Utils/TimeUtils';


describe('InfrastructureJob', () => {

    const dataService = {} as DataService;
    let testData: IRawInfrastructureJob;
    ...
    fit('validate complete repairTask', () => {
        const task = new InfrastructureJob(dataService, testData);
    ...
    fit('validate repairTask history in executing', () => {
        ...
        const task = new InfrastructureJob(dataService, testData, dateRef);
