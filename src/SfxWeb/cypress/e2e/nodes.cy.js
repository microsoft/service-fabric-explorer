...
context('nodes events with node type filter', () => {
    beforeEach(() => {
        addDefaultFixtures();
        // Override default nodes fixture with mixed node types BEFORE page load
        // so the NodeCollection is populated with FrontEnd/BackEnd types
